...
import it.isac.server.resources.NetworkServerResource;
...
public class ServerApplication extends Application {
	...
	public Restlet createInboundRoot() {
		...
		router.attach(BASE_URL + UrlAttributes.getRelNetUrl(),
				NetworkServerResource.class);
	...
	void configureLogger() throws SecurityException, IOException {
		...
		// FileHandler fileHandler = new FileHandler(dir + "logfile%g.log",
		// 5242880, 5, true);
